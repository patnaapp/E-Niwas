...
public class SplashActivity extends Activity {
    ...
    public void modifyTable(){
        ...
        if(isColumnExists("SurfaceSchemeDetail", "UserRole") == false){
...
//    public void validateAppVersion(final Versioninfo versioninfo){
//
//        if(versioninfo != null){
//
//            String currentVersion = getappversion();
//
//            if(Double.parseDouble(versioninfo.get().trim()) > Double.parseDouble(currentVersion.trim())){
//
//                AlertDialog.Builder ab = new AlertDialog.Builder(SplashActivity.this);
//
